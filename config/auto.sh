...
#nohup /bin/bash /usr/src/app/live-dl -ac https://www.youtube.com/channel/UCP0BspO_AMEe3aQqqpo89Dg/community &>/tmp/live-dl-moona-membership.$(date +%d%b%y-%H%M%S).log &
